...
-- En sampling_plots, sabemos cuál es el ciclo activo actual
ALTER TABLE sampling_plots ADD COLUMN current_cycle_number INT DEFAULT 1;

-- En species_zone, etiquetamos cada registro con el ciclo en el que se creó
ALTER TABLE species_zone ADD COLUMN cycle_number INT DEFAULT 1;

-- Identificador de ciclo para las zonas (por si cambian entre investigaciones)
ALTER TABLE studies_zones ADD COLUMN cycle_number INT NOT NULL DEFAULT 1;